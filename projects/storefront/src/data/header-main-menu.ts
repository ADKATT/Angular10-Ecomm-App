            ...
            links: [
                {
                    ...
                    url: '/shop/category',
                    links: [
                        {title: 'Brands', url: '/shop/category-columns-3-sidebar'},
                        {title: 'Car Lines', url: '/shop/category-columns-4-sidebar'},
                        {title: 'Featured Brands', url: '/shop/category-columns-5-sidebar'},
