...
export class LayoutComponent implements OnInit, OnDestroy {
    ...
    private initNavigation(): void {
        this.navigation = [
            ...
            {type: 'link', label: 'Quote price', url: '/sales-portal/quote-price'},
            {type: 'link', label: 'Chat Email Time', url: '/sales-portal/chat-email-time'},
            {type: 'link', label: 'Set Status', url: '/sales-portal/set-status'},
            {type: 'link', label: 'Password', url: '/reset-password/password'},
