...
export class PageEditAddressComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        ...
        this.route.params.pipe(
            ...
            switchMap(addressId => combineLatest([
                addressId ? this.userService.getAddress(addressId) : of(null),
    ...
    save(): void {
        ...
        if (this.addressId) {
            saveMethod = this.userService.editAddress(this.addressId, addressData);
        } else {
            saveMethod = this.userService.addAddress(addressData);
        }
