        ...
        this.tabs = [
            {
                ...
                products$: this.shopService.getFeaturedProducts(this.category.slug, 6),
            },
            {
                name: 'TEXT_TAB_BESTSELLERS',
                products$: this.shopService.getPopularProducts(this.category.slug, 6),
            },
            {
                name: 'TEXT_TAB_TOP_RATED',
                products$: this.shopService.getTopRatedProducts(this.category.slug, 6),
            },
        ];
