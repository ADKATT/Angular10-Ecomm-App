...
export class AccountMenuComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        this.isAuth$ = this.userService.user$.pipe(map(x => x !== null));
        this.firstName$ = this.userService.user$.pipe(map(x => x ? x.firstName : null));
        this.lastName$ = this.userService.user$.pipe(map(x => x ? x.lastName : null));
        this.fullName$ = this.userService.user$.pipe(map(x => x ? x.user : null));
        this.email$ = this.userService.user$.pipe(map(x => x ? x.email : null));
        this.avatar$ = this.userService.user$.pipe(map(x => x ? x.profileImage : null)); 
    ...
    validateIP(): void {
        this.userService.validateIP().pipe(
