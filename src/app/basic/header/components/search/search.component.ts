...
export class SearchComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    ngOnInit(): void {
        ...
        this.searchPlaceholder$ = this.vehicleService.currentVehicle$.pipe(
            switchMap(vehicle => {
                if (vehicle) {
