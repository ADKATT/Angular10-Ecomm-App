...
import { ShopSidebarService } from '../../../basic/shop/services/shop-sidebar.service';
import { PageShopService } from '../../../basic/shop/services/page-shop.service';
import { ActivatedRoute, Params, Router } from '@angular/router';
import { ShopService } from '../../../services/shop.service';
import { merge, Observable, of, Subject } from 'rxjs';
import { map, switchMap, takeUntil, tap, finalize } from 'rxjs/operators';
import { UrlService } from '../../../services/url.service';
import { Breadcrumb } from '../../../basic/shared/components/block-header/block-header.component';
...
import { filterHandlers } from '../../../basic/shop/filters/filter-handlers';
        ...
        this.route.data.pipe(
            switchMap((data: PageShopData) => merge(
                ...
                this.page.optionsChange$.pipe(
                    ...
                    switchMap(options => this.shopService.getProductsList(options)),
                ),
            )),
	...
	/*getInventoryProducts(): void {
		this.productService.getInventoryProducts().pipe(
			...
			res => {
				...
				return this.page.setList(res.data);
			},
			err => {
				console.log(err);
			},
