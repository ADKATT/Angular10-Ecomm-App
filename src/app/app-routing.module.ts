...
const routes: Routes = [
     ...
     */
    {
        ...
        children: [
            ...
            {
                path: 'blog',
                loadChildren: () => import('./basic/blog/blog.module').then(m => m.BlogModule),
            },
            {
                path: 'account',
                loadChildren: () => import('./basic/account/account.module').then(m => m.AccountModule),
            },
			{
                path: 'site',
                loadChildren: () => import('./basic/site/site.module').then(m => m.SiteModule),
            },
			{
                path: 'about',
